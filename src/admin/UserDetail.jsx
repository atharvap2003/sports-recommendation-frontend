    ...
    <div className="content-area">
      ...
      <div className="space-y-6">
            ...
            <div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-800 dark:text-gray-300">{user.name}</p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-800 dark:text-gray-300">{user.phone}</p>
                </div>
                <div>
                ...
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400">Emergency Contact</label>
                  <p className="text-gray-800 dark:text-gray-300">{user.emergencyContact}</p>
                </div>
              </div>
            </div>
            
            <div>
              <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Sports Information</h2>
              <div className="space-y-4">
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400">Primary Sport</label>
                  <p className="text-gray-800 dark:text-gray-300">{user.sport}</p>
                </div>
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400">Join Date</label>
                  <p className="text-gray-800 dark:text-gray-300">{new Date(user.joinDate).toLocaleDateString()}</p>
                </div>
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400">Membership Type</label>
                  <p className="text-gray-800 dark:text-gray-300">{user.membership}</p>
                </div>
                <div>
                  <label className="block text-sm text-gray-500 dark:text-gray-400">Attendance Rate</label>
                  <p className="text-gray-800 dark:text-gray-300">{user.attendance}</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="card">
            <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Upcoming Events</h2>
            <ul className="space-y-2">
        ...
        <div className="card">
          <h2 className="text-lg font-semibold mb-4 text-gray-800 dark:text-white">Equipment Borrowed</h2>
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y dark:divide-gray-700">
                {user.equipmentBorrowed.map((item, index) => (
                  <tr key={index}>
                    <td className="px-4 py-2 text-gray-800 dark:text-gray-300">{item.item}</td>
